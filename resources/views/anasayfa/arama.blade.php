                                    ...
                                    <div class="col-md-12">
                                        <article class="zm-post-lay-a">
                                            <div class="zm-post-thumb">
                                                <a href="/yazi/{{$yazi->id}}/{{$yazi->slug}}"><img src="/{{$yazi->resim}}" alt="img" width="803" height="450"></a>
                                            </div>
                                            <div class="zm-post-dis">
                                                <div class="zm-post-header">
                                                    <div class="zm-category"><a href="/kategori/{{$yazi->kategori->id}}/{{$yazi->kategori->slug}}" class="bg-cat-5 cat-btn">{{$yazi->kategori->baslik}}</a></div>
