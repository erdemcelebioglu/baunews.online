                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="single-input">
                                ...
                                <input id="name" type="text" class="form-horizontal" name="name" value="{{$profilim->name}}" required>
                            </div>
                           ...
                           <div class="single-input">
                            ...
                            <div class="single-input">
                                ...
                                <img border="0" src="/{{$profilim->avatar}}" width="100" height="75">
                            </div>

                            <div class="single-input">
                                <label>Avatar</label>
                                <input id="password" type="file" class="form-control name="avatar">
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                                        <div class="single-input">
                                            <button class="submit-button mt-30 inline-block" type="submit">Profil Güncelle</button>
                                        </div>
