...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="{{route('yonetim.index')}}" class="visible-phone"><i class="icon icon-home"></i> Yönetim Paneli</a>
    <ul>
        <li class="active"><a href="{{route('yonetim.index')}}" target="_blank"><i class="icon icon-home"></i> <span>Yönetim Paneli</span></a> </li>

        <li><a href="{{route('anasayfa')}}"><i class="icon icon-home"></i> <span>Site Anasayfa</span></a> </li>
        ...
        <li><a href="{{route('reklam.goster')}}"><i class="icon icon-link"></i> <span>Reklam Ayarları</span></a> </li>
        <li><a href="{{route('ceviri.index')}}"><i class="icon-resize-horizontal"></i> <span>Çeviri Yönetimi</span></a> </li>
    </ul>
</div>
<!--sidebar-menu-->
