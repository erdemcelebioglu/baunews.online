...
class YonetimController extends Controller
{
    ...
    public function kullanicikayit(request $request){
        ...
        if (request('password') != request('password_confirmation')){
            ...
            alert()->error('Başarısız','Şifreler Eşleşmiyor');
        ...
        $kullanici->save();
        if ($kullanici) {
            alert()->success('Başarılı','Kullanıcı Eklendi');
            ...
            alert()->error('Başarısız','Kullanıcı Eklenemedi');
    ...
    public function kullaniciguncelle($id){
        ...
        $kullanici->save();
        if ($kullanici) {
            alert()->success('Başarılı','Kullanıcı Güncellendi');
            ...
            alert()->error('Başarısız','Kullanıcı Güncellenemedi');
    ...
    public function kullanicisil($id){
        ...
        if ($sil) {
            alert()->success('Başarılı','Kullanıcı Silindi');
            ...
            alert()->error('Başarılı','Kullanıcı Silinemedi');
